package LegalPublisher::Municode;
use strict;
use warnings;
...
sub subdivisions {
    ...
    my $subdivisions_url = $config->{'legal publisher'}->{'municode'}->{'origin'};
    ...
    $mech->follow_link(url_regex => qr/https:\/\/www\.municode\.com\/library\/${filter}/);
